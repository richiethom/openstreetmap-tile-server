...
docker run -v /tmp/tiles:/tiles -v /tmp/data.osm.pbf:/data.osm.pbf -v openstreetmap-data:/var/lib/postgresql/10/main richiethom/osmtilegenerator import $2 $3 $4 $5 $6
